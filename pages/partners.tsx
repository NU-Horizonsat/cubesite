...
export default function Partners() {
    const partner = [
        {
            title: "NASA CSLI",
            description: " is a program offers an opportunity for universities, high schools, and non-profit organizations in the United States to access space. They provide us cost-effective pathway for building, testing and launching THIS-SAT.",
